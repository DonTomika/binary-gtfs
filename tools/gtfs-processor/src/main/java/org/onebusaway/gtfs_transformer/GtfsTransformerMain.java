...
public class GtfsTransformerMain {
  ...
  public void run(String[] args) throws IOException
  {
    try
    {
        ...
        ProcessFeedStrategy strategy = new ProcessFeedStrategy(new File(args[1]));
        transformer.addTransform(strategy);
        
        System.setOut(new PrintStream(new File(args[2])));
        
        //GtfsTransformerLibrary.configureTransformation(transformer, "{\"op\":\"transform\", \"class\": \"org.onebusaway.gtfs_transformer.updates.ProcessFeedStrategy\"}");
